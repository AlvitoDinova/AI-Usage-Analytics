...
<div class="row g-4 mb-4">
        ...
        <div class="card card-hover h-100">
            <div class="card-body d-flex align-items-center justify-content-between">
                <div>
                    ...
                    <h3 class="mb-0 fw-bold">{{ $stats['total_ai_tools'] }}</h3>
                </div>
        ...
        <div class="card card-hover h-100">
            <div class="card-body d-flex align-items-center justify-content-between">
                <div>
                    ...
                    <h3 class="mb-0 fw-bold">{{ $stats['total_kriteria'] }}</h3>
                </div>
        ...
        <div class="card card-hover h-100">
            <div class="card-body d-flex align-items-center justify-content-between">
                <div>
                    ...
                    <h3 class="mb-0 fw-bold">{{ $stats['total_proyek'] }}</h3>
                </div>
    ...
    <div class="col-12 col-md-6 col-lg-3">
        <div class="card card-hover h-100">
            <div class="card-body d-flex align-items-center justify-content-between">
                <div>
                    <h6 class="card-header-title mb-2">Total Evaluasi TOPSIS</h6>
                    <h3 class="mb-0 fw-bold">{{ $stats['total_evaluasi'] }}</h3>
                </div>
...
<div class="row g-4 mb-4">
                ...
                <div>
                    ...
                    <h4 class="mb-0 fw-bold text-success">
                        @if($stats['ai_terbaik_terakhir'] !== '-')
                            <i class="bi bi-award-fill text-warning me-1"></i>{{ $stats['ai_terbaik_terakhir'] }}
                        @else
                            -
                        @endif
                    </h4>
    ...
    <div class="col-12 col-md-6">
        <div class="card card-hover h-100">
            <div class="card-body d-flex align-items-center justify-content-between">
                <div>
                    <h6 class="card-header-title mb-2">Proyek Terakhir Dievaluasi</h6>
                    <h5 class="mb-0 fw-bold text-dark text-truncate" style="max-width: 450px;">{{ $stats['proyek_terakhir_dievaluasi'] }}</h5>
                </div>
                ...
                <div class="d-flex flex-column gap-3">
                    <div class="d-flex align-items-center justify-content-between p-3 bg-light rounded-3 border border-light-subtle">
                        <div class="d-flex align-items-center gap-3">
                            ...
                            <div>
                                <h6 class="mb-1 fw-bold">Mulai Penilaian Proyek Baru</h6>
                                <p class="text-muted mb-0" style="font-size: 0.75rem;">Evaluasi dan cari rekomendasi AI terbaik untuk proyek agensi.</p>
                            </div>
                        </div>
                    ...
                    <div class="d-flex align-items-center justify-content-between p-3 bg-light rounded-3 border border-light-subtle">
                        <div class="d-flex align-items-center gap-3">
                            ...
                            <div>
                                <h6 class="mb-1 fw-bold">Lihat Riwayat Evaluasi</h6>
                                <p class="text-muted mb-0" style="font-size: 0.75rem;">Tinjau dan cetak laporan hasil perhitungan TOPSIS sebelumnya.</p>
                            </div>
                        </div>
                        <a href="{{ route('coming-soon') }}" class="btn btn-sm btn-outline-secondary px-3 rounded-2">Riwayat</a>
                    </div>
                </div>
            </div>
        </div>
